...
public static class PermissionCatalog
{
    public static IReadOnlyList<PermissionDefinition> All { get; } = new List<PermissionDefinition>
    {
        ...
        new(PermissionCodes.Buttons.Address.AddProductProcess, "Add Product Process", PermissionType.Button, PermissionCodes.Pages.AddressManage, 840),
        new(PermissionCodes.Buttons.Address.DeleteProductProcess, "Delete Product Process", PermissionType.Button, PermissionCodes.Pages.AddressManage, 850),
        new(PermissionCodes.Buttons.Address.PreviewProductProcessAddress, "Preview Product Process Address", PermissionType.Button, PermissionCodes.Pages.AddressManage, 860),
        new(PermissionCodes.Buttons.Address.AddScheme, "Add Scheme", PermissionType.Button, PermissionCodes.Pages.AddressManage, 870),
        new(PermissionCodes.Buttons.Address.DeleteScheme, "Delete Scheme", PermissionType.Button, PermissionCodes.Pages.AddressManage, 880),
        new(PermissionCodes.Buttons.Address.AddTestItem, "Add Test Item", PermissionType.Button, PermissionCodes.Pages.AddressManage, 890),
        new(PermissionCodes.Buttons.Address.DeleteTestItem, "Delete Test Item", PermissionType.Button, PermissionCodes.Pages.AddressManage, 900),
    };
}
