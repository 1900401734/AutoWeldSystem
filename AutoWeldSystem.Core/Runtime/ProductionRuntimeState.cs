...
public class ProductionRuntimeState
{
    ...
    public bool IsTaskRunning => ActiveTask is not null
        && string.Equals(ActiveTask.TaskStatus, ProductionConstants.ProductInstanceStatuses.Running, StringComparison.OrdinalIgnoreCase);
    ...
    public void RestoreStation(int stationNo)
    {
        ...
        MesOperatorInfo = station.MesOperatorInfo;
    }
    ...
    public void SaveCurrentStation()
    {
        ...
        station.MesOperatorInfo = MesOperatorInfo;
