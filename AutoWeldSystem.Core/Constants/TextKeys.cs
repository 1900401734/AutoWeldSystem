...
public static class TextKeys
{
    ...
    public static class Monitor
    {
        ...
        public static class RuntimeError
        {
            ...
            /// PLC 业务信号读取失败
            /// </summary>
            public const string PlcBusinessSignalReadFailed = "monitor.error.plc_business_signal_read_failed";
            /// <summary>
            /// PLC 报警地址读取失败
            /// </summary>
    ...
    public static class DataManage
    {
        ...
        public const string ExportProgramLimits = "data.checkbox.export_program_limits";
        public const string ExportOptionsSaveFailed = "data.message.export_options_save_failed";
    ...
    public static class Permission
    {
        ...
        public const string TabLogDevice = "permission.tab.log.device";
        public const string TabLogDeviceStatus = "permission.tab.log.device_status";
        public const string TabLogServer = "permission.tab.log.server";
        public const string TabAddressBusinessSignal = "permission.tab.address.business_signal";
        public const string TabAddressRecipeName = "permission.tab.address.recipe_name";
        public const string TabAddressAlarm = "permission.tab.address.alarm";
        public const string TabAddressProductProcess = "permission.tab.address.product_process";
        public const string TabAddressTestPlan = "permission.tab.address.test_plan";
        public const string TabAddressPlanDetail = "permission.tab.address.plan_detail";
        public const string TabAddressTestItemDictionary = "permission.tab.address.test_item_dictionary";
    ...
    public static class SystemSetting
    {
        ...
        public const string MessageSettingsSavedDeviceSyncBackground = "system.message.settings_saved_device_sync_background";
        public const string MessageDeviceSyncManualConfirmationRequired = "system.message.device_sync_manual_confirmation_required";
